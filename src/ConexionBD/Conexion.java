...
public class Conexion {
    ...
    public boolean conectar(boolean autoCommit) {
        try {
            ...
            //System.out.println(autenticacion.getIpBD()+" "+autenticacion.getUsuarioBD()+" "+autenticacion.getClaveBD());
            conexion = DriverManager.getConnection("jdbc:mysql://" + autenticacion.getIpBD() + "/biblioteca", autenticacion.getUsuarioBD(), autenticacion.getClaveBD());            
