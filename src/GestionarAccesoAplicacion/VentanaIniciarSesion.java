...
public class VentanaIniciarSesion {
	...
	public void aceptar(){
		...
		Usuarios usuario = dao.validarUsuario(_usuario, _clave);
		if(usuario == null){
			...
			MostrarMensajes.mostrarMensaje(ventana, "Bienvenido(a): "+usuario.getNombres(), MostrarMensajes.MENSAJE_EXITO);
